...
void union_set(struct link_list* set1, struct link_list* set2,
               struct link_list* set3); // performs AUB
void intersection_set(struct link_list* set1, struct link_list* set2,
                      struct link_list* set3); // performs A intersection B
void difference_set(struct link_list* set1, struct link_list* set2,
                    struct link_list* set3); // performs A - B
...
void init_set(struct link_list* set) { // initialize set. I don't know what to do with first element
                                       // so i just deafulted it :P
    set->value = "";
    set->next = NULL;
}
